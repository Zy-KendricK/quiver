...
export default function PersonalSettings() {
    const userImage = "/img/team-1-800x800.jpg";
        ...
        <>
            <div className="flex flex-col md:flex-row border-b border-gray-200 py-8">
                ...
                <div className="flex flex-col md:flex-row md:pl-4 md:w-2/6">
                    <div className="w-full md:w-1/3 flex flex-row">
                        <div className="w-1/2 w-full">
                            <Image alt="..." className="p-2 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={userImage} width={70} height={70} />
                        </div>
                        <div className="w-1/2 w-full">
                            <img alt="..." className="p-2 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={createObjectURL} width={70} height={70} />
                        </div>
                    </div>
                    <div className="w-full md:w-2/3 flex-1 mx-2">
                        ...
                        <input type="file" className="mt-2 capitalize text-transparent" name="myImage" onChange={uploadToClient} />
                        <a href="#">
            ...
            <div className="flex flex-col md:flex-row border-b border-gray-200 py-8">
                <div className="md:w-1/6 font-bold mb-3 mx-2 text-gray-800 md:pr-4">Name
            ...
            <div className="flex flex-col md:flex-row py-8">
                <div className="md:w-1/6 font-bold mx-2 mt-3 text-gray-800 md:pr-4">Email Address
                    <div className="text-sm font-normal mb-5 text-gray-400">Changes made to your email would be visible to others on the team</div>
                </div>
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-2/6 flex flex-col md:flex-row-reverse">
