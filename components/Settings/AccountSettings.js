...
export default function AccountSettings() {
    ...
    return (<>
        ...
        <div className="flex flex-col md:flex-row pt-8">
            <div className="md:w-1/6 font-bold h-6 mx-2 text-gray-800 md:pr-4">Password Change
            ...
            <div className="flex flex-col md:pl-4 md:w-2/6">
                ...
                <div className="w-full flex-1 md:px-6">
        ...
        <div className="flex flex-col border-b border-gray-200 md:py-8 md:flex-row">
            ...
            <div className="md:w-2/6 flex flex-col md:flex-row md:pb-4 md:flex-row-reverse">
